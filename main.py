...
# from sklearn.metrics import confusion_matrix, plot_confusion_matrix # sklearn modify this method to a Class
...
from models.posterv2 import *
#from models.HFFT_model import HFFT
#from models.HFFT_model_LBP import HFFT_LBP
...
def main():
    ...
    cudnn.benchmark = True # causes cuDNN to benchmark multiple convolution algorithms and select the fastes
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_acc, train_los = train(train_loader, model, criterion, optimizer, epoch, args) # criterion is CrossEntropy
...
class RecorderMeter1(object):
    ...
    def plot_confusion_matrix(self, cm, title='Confusion Matrix', cmap=plt.cm.binary):
        ...
        disp = ConfusionMatrixDisplay(cm_normalized, 'Normalized confusion matrix')
        disp.plot()
