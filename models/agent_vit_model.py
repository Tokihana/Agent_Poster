...
class Block(nn.Module):
    def __init__(self,
        ...
        self.attn = AgentAttention(
                ...
                attn_drop=attn_drop_ratio, proj_drop=drop_ratio, sr_ratio=sr_ratio,
                agent_num=agent_num)
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=14, patch_size=14, in_c=147, num_classes=7,
        ...
        self.blocks = nn.Sequential(*[
            Block(dim=embed_dim, in_chans=in_c, num_heads=num_heads, num_patches=self.num_patches,mlp_ratio=mlp_ratio, qkv_bias=qkv_bias,
                  qk_scale=qk_scale,
